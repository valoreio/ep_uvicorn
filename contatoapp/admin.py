...
class ContatosAdmin(admin.ModelAdmin):
    ...
    # inclui uma barra lateral a direita que permite filtrar os resultados com base nos campos abaixo
    list_filter = ['dt_criacao','name','email','phone','mensagem','status','ipaddress','dt_atualiz','compayname','cnpjcpf','subject','paymentmethod','agree_term_participation_privacy_SN']
